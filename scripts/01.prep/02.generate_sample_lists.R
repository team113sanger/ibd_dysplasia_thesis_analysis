...
progressors_ppat <- get_samples(meta, group, "Progressor") |>
  setdiff(extra_samples)
write_lines(progressors_ppat, file.path(outdir, "progressor_samples_ppat.tsv"))
...
progressor_precursors_ppat <- progressor_precursors |> 
  setdiff(extra_samples)
write_lines(progressor_precursors_ppat, file.path(outdir, "progressor_precursor_samples_ppat.tsv"))
...
progressor_follow_ups_ppat <- progressor_follow_ups |> 
  setdiff(extra_samples)
write_lines(progressor_follow_ups_ppat, file.path(outdir, "progressor_follow_up_samples_ppat.tsv"))
...
non_progressors_ppat <- non_progressors |> 
  setdiff(extra_samples)
write_lines(non_progressors_ppat, file.path(outdir, "non_progressor_samples_ppat.tsv"))
...
non_progressor_precursors_ppat <- non_progressor_precursors |> 
  setdiff(extra_samples)
write_lines(non_progressor_precursors_ppat, file.path(outdir, "non_progressor_precursor_samples_ppat.tsv"))
...
non_progressor_follow_ups_ppat <- non_progressor_follow_ups |> 
  setdiff(extra_samples)
write_lines(non_progressor_follow_ups_ppat, file.path(outdir, "non_progressor_follow_up_samples_ppat.tsv"))
...
low_grade_ppat <- low_grade |> 
  setdiff(extra_samples)
write_lines(low_grade_ppat, file.path(outdir, "low_grade_samples_ppat.tsv"))
...
high_grade_ppat <- high_grade |> 
  setdiff(extra_samples)
write_lines(high_grade_ppat, file.path(outdir, "high_grade_samples_ppat.tsv"))
...
carinoma_ppat <- carinoma |> 
  setdiff(extra_samples)
write_lines(carinoma_ppat, file.path(outdir, "adenocarcinoma_samples_ppat.tsv"))

all_ppat <- c(non_progressors_ppat, progressors_ppat) |>
  write_lines(file.path(outdir, "all_one_ppat.list"))