...
# Save
ggsave("plots/variants/gene_boxplots_pres.png", plots[[1]], width = 2, height = 5, dpi = 300)
ggsave("plots/variants/gene_boxplots_fols.png", plots[[2]], width = 2, height = 5, dpi = 300)
